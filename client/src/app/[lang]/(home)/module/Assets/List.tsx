...
const List: React.FC<Props> = (props) => {
  ...
  return (
    <Card className="p-6 max-sm:hidden">
      ...
      <Table>
        <TableCaption className="cursor-pointer">+ Add new assets</TableCaption>
        <TableHeader>
          <TableRow>
            <TableHead className="w-[300px]">Name</TableHead>
            <TableHead className="w-[200px]">Price/24h change</TableHead>
        ...
        <TableBody>
          {tokens.map((token) => (
            <TableRow key={token.symbol} className="group border-border">
              ...
              <TableCell>{token.price.price * token.totalUiAmount}</TableCell>
              <TableCell>
                  ...
                  <div>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent className="w-56">
                        ...
                        <DropdownMenuItem>View in Explore</DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
                  </div>
                </div>
